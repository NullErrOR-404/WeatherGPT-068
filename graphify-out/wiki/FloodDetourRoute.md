...
> God node · 19 connections · [C:\WeatherGPT-068\backend\models\schemas.py](file:///C:/WeatherGPT-068/backend/models/schemas.py#L129)

## Call Trace Diagram

```mermaid
sequenceDiagram
    participant P0 as FloodDetourRoute
    ...
    participant P27 as .get_detour_advisory()
    participant P28 as FloodRoutingService
    participant P29 as Preemptive Flood Detour Navigator. Pairs live radar precipitation intensity with
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
...
- [[FloodRoutingService]] `INFERRED`
- [[Preemptive Flood Detour Navigator. Pairs live radar precipitation intensity with]] `INFERRED`
