...
> God node · 20 connections · [C:\WeatherGPT-068\backend\models\schemas.py](file:///C:/WeatherGPT-068/backend/models/schemas.py#L122)

## Call Trace Diagram

```mermaid
sequenceDiagram
    participant P0 as IVROutboundResponse
    ...
    participant P28 as .handle_missed_call()
    participant P29 as 2G Button-Phone Telephony Bridge Service. Handles inbound missed-call webhooks,
    participant P30 as Generates ultra-dense 160-character USSD/SMS payload for transmission during tot
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
