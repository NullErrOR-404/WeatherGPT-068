...
> God node · 20 connections · [C:\WeatherGPT-068\backend\models\schemas.py](file:///C:/WeatherGPT-068/backend/models/schemas.py#L73)

## Call Trace Diagram

```mermaid
sequenceDiagram
    participant P0 as ChatQuery
    ...
    participant P27 as AIChatService
    participant P28 as test_chat_spray_query_intent()
    participant P29 as Conversational AI Service. Integrates Grounded Intent Parsing, Spatial Semantic
    participant P30 as test_spatial_cache_deduplication()
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
...
### calls
- [[test_chat_spray_query_intent()]] `INFERRED`
- [[test_spatial_cache_deduplication()]] `INFERRED`
