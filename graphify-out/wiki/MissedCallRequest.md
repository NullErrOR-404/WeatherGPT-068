...
> God node · 20 connections · [C:\WeatherGPT-068\backend\models\schemas.py](file:///C:/WeatherGPT-068/backend/models/schemas.py#L115)

## Call Trace Diagram

```mermaid
sequenceDiagram
    participant P0 as MissedCallRequest
    ...
    participant P21 as IVROutboundResponse
    participant P22 as ChatResponse
    participant P23 as CitizenHazardReport
    participant P24 as AntiFakeValidationResult
    participant P25 as FloodDetourRoute
    participant P26 as MandiRainShieldReport
    participant P27 as TelecomBridgeService
    participant P28 as 2G Button-Phone Telephony Bridge Service. Handles inbound missed-call webhooks,
    participant P29 as Generates ultra-dense 160-character USSD/SMS payload for transmission during tot
    participant P30 as test_telecom_bridge_missed_call()
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
...
### calls
- [[test_telecom_bridge_missed_call()]] `INFERRED`
...
- [[TelecomBridgeService]] `INFERRED`
- [[2G Button-Phone Telephony Bridge Service. Handles inbound missed-call webhooks,]] `INFERRED`
- [[Generates ultra-dense 160-character USSD/SMS payload for transmission during tot]] `INFERRED`
