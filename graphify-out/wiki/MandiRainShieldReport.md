...
> God node · 19 connections · [C:\WeatherGPT-068\backend\models\schemas.py](file:///C:/WeatherGPT-068/backend/models/schemas.py#L139)

## Call Trace Diagram

```mermaid
sequenceDiagram
    participant P0 as MandiRainShieldReport
    ...
    participant P24 as CitizenHazardReport
    participant P25 as AntiFakeValidationResult
    participant P26 as FloodDetourRoute
    participant P27 as .check_mandi_risk()
    participant P28 as MandiShieldService
    participant P29 as APMC Mandi Grain Shield Service. Monitors open-air grain storage yards and trigg
    P0->>+ P1: uses
    P1-->>- P0: return
    P1->>+ P2: uses
    P2-->>- P1: return
...
- [[MandiShieldService]] `INFERRED`
- [[APMC Mandi Grain Shield Service. Monitors open-air grain storage yards and trigg]] `INFERRED`
